...
const AboutMe = () => {
        ...
        <div className={styles['background']}>
            <div className="row">
                ...
                <div className="col-lg-8">
                    <p>My name is Danielle Kuhn and I am a frontend developer with backend experience.</p>
                    <p>I entered the tech industry about five years ago when I founded a global payments company because I love solving complex problems, especially through the use of technology. Throughout that journey I realized 
    ...
    {/* <div className={styles['spaceImage']}></div> */}
        <img className={styles['spaceImage']} src={computer} alt="Background"/>
    </div>
    )
}
